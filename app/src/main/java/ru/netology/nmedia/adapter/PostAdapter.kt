...
class PostAdapter(private val onItemLikeListener:OnItemLikeListener) : RecyclerView.Adapter<PostViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        return PostViewHolder(binding, onItemLikeListener)
    }
